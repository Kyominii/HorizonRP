local weashop = {
	...
	menu = {
		...
		["main"] = {
			...
			name = "main",
			buttons = {
				{title = "Corps à corps", name = "Melee", description = ""},
				...
				{title = "Armes d'assault", name = "AssaultRifles", description = ""},
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Couteau", name = "Knife", costs = 1000, description = {}, model = "WEAPON_Knife"},
				--{title = "Nightstick", name = "Nightstick", costs = 1000, description = {}, model = "WEAPON_Nightstick"},
				{title = "Marteau", name = "Hammer", costs = 1000, description = {}, model = "WEAPON_HAMMER"},
				{title = "Batte", name = "Bat", costs = 1000, description = {}, model = "WEAPON_Bat"},
				{title = "Barre à mine", name = "Crowbar", costs = 1000, description = {}, model = "WEAPON_Crowbar"},
				{title = "Club de golf", name = "Golfclub", costs = 1000, description = {}, model = "WEAPON_Golfclub"},
				...
				{title = "Hachette", name = "Hatchet", costs = 1000, description = {}, model = "WEAPON_Hatchet"},
				--{title = "KnuckleDuster", name = "KnuckleDuster", costs = 120000, description = {}, model = "WEAPON_KnuckleDuster"},
				{title = "Machette", name = "Machete", costs = 1000, description = {}, model = "WEAPON_Machete"},
				{title = "Flashlight", name = "Flashlight", costs = 1000, description = {}, model = "WEAPON_Flashlight"},
		...
		["Pistolets"] = {
			...
			name = "Pistolets",
			buttons = {
				{title = "Pistolet", name = "Pistol", costs = 10000, description = {}, model = "WEAPON_Pistol"},
				{title = "Pistolet de combat", name = "CombatPistol", costs = 12000, description = {}, model = "WEAPON_CombatPistol"},
				{title = "Pistolet Cal. 50", name = "Pistol50", costs = 15000, description = {}, model = "WEAPON_PISTOL50"},
				{title = "Pistolet SNS", name = "SNSPistol", costs = 10000, description = {}, model = "WEAPON_SNSPistol"},
				{title = "Pistolet Lourd", name = "HeavyPistol", costs = 20000, description = {}, model = "WEAPON_HeavyPistol"},
				{title = "Pistolet Vintage", name = "VintagePistol", costs = 25000, description = {}, model = "WEAPON_VintagePistol"},
				{title = "Pistolet Marksman", name = "MarksmanPistol", costs = 10000, description = {}, model = "WEAPON_MarksmanPistol"},
				{title = "Revolver", name = "Revolver", costs = 10000, description = {}, model = "WEAPON_Revolver"},
				{title = "Pistolet AP", name = "APPistol", costs = 10000, description = {}, model = "WEAPON_APPistol"},
		...
		["MachineGuns"] = {
			...
			name = "MachineGuns",
			buttons = {
				{title = "MicroSMG", name = "MicroSMG", costs = 25000, description = {}, model = "WEAPON_MicroSMG"},
				{title = "Pistolet automatique", name = "MachinePistol", costs = 25000, description = {}, model = "WEAPON_MachinePistol"},
				{title = "SMG", name = "SMG", costs = 25000, description = {}, model = "WEAPON_SMG"},
				{title = "SMG d'assault", name = "AssaultSMG", costs = 30000, description = {}, model = "WEAPON_AssaultSMG"},
				{title = "PDW", name = "CombatPDW", costs = 30000, description = {}, model = "WEAPON_CombatPDW"},
				{title = "MG", name = "MG", costs = 30000, description = {}, model = "WEAPON_MG"},
				{title = "MG de combat", name = "CombatMG", costs = 35000, description = {}, model = "WEAPON_CombatMG"},
				{title = "Gusenberg", name = "Gusenberg", costs = 35000, description = {}, model = "WEAPON_Gusenberg"},
				{title = "Mini SMG", name = "MiniSMG", costs = 35000, description = {}, model = "WEAPON_MiniSMG"},
			}
		},
		--[[["Shotguns"] = {
			title = "Shotgun",
		...
		["AssaultRifles"] = {
			title = "Armes d'assault",
			name = "AssaultRifles",
			buttons = {
				{title = "Fusil d'assault", name = "AssaultRifle", costs = 250000, description = {}, model = "WEAPON_AssaultRifle"},
				{title = "Carbine d'assault", name = "CarbineRifle", costs = 250000, description = {}, model = "WEAPON_CarbineRifle"},
				{title = "Fusil spécial", name = "AdvancedRifle", costs = 300000, description = {}, model = "WEAPON_AdvancedRifle"},
				{title = "Carabine spécial", name = "SpecialCarbine", costs = 310000, description = {}, model = "WEAPON_SpecialCarbine"},
...
RegisterNetEvent('weaponshop:looseWeapons')
AddEventHandler('weaponshop:looseWeapons', function()
	Citizen.CreateThread(function()
