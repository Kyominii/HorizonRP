...
AddEventHandler('esx_phone:addPlayerContact', function(phoneNumber)
		...
		TriggerEvent('es:getPlayers', function(xPlayers)
			...
			if foundNumber then
				...
				TriggerEvent('es:getPlayerFromId', _source, function(xPlayer)
...
AddEventHandler('esx_phone:responsePlayerNameForAddPlayerContact', function(playerName, phoneNumber, requestSource)
		TriggerEvent('es:getPlayerFromId', requestSource, function(xPlayer)
