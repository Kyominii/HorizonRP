...
appartements = {
	{ 
		...
		appts = {
			{name = "Etage 1", x = -774.67, y = 331.566, z = 158.981, h = 351.82},  --- ONE appartment by line, position : x, y, z and h for heading direction !
			{name = "Etage 2", x = -774.168, y = 331.165, z = 206.611, h = 351.82},
			{name = "Etage 3", x = -785.304, y = 323.667, z = 210.987, h = 268.62}
		}
	},
	{ 
		ext = {name = "Richard Magestique", x = -936.49, y = -379.42, z = 38.01, h = 183.14},
		appts = {
			{name = "Etage 1", x = -912.447, y = -365.123, z = 113.30, h = 351.82},  --- ONE appartment by line, position : x, y, z and h for heading direction !
			{name = "Heliport", x = -902.696, y = -369.72, z = 135.3, h = 351.82}
		}
	},
	{ 
		ext = {name = "Del Perro", x = -1447.60, y = -537.38, z = 33.90, h = 183.14},
		appts = {
			{name = "Etage 1", x = -1452.12, y = -540.58, z = 73.1, h = 351.82},  --- ONE appartment by line, position : x, y, z and h for heading direction !
			{name = "Toit", x = -902.696, y = -369.72, z = 79.1, h = 351.82}
		}
	}		
}		
