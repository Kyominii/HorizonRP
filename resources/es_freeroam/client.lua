...
AddEventHandler("playerSpawned", function(spawn)    
    ...
    Citizen.CreateThread(function()
		...
		AddTextComponentString("Bienvenue sur ~g~Horizon!.\n ~y~Plus d'info sur *A VENIR*.");
		SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Notification", "Horizon");
